...
/**
* struct bulltin - This contain the  bultin to handle and function inorder to excute
* @command:pointer to char
* @fun:fun to excute when the bultin is true
*/
...
/** ### String functions ### */
char *_strcheck(char *str, const char *check);
